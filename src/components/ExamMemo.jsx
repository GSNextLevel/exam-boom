...
class ExamMemo extends Component {
  constructor(props) {
    super(props);
  ...
  //   await api.getExamMemoById(type, examNum).then((exam) => {
  ...
  async writeReply() {
    ...
    await api.updateExamMemoById(type, examNum, payload).then((res) => {
      // console.log(exam);
      console.log(res);
  ...
  async deleteReply(username, id) {
    ...
    await api.deleteExamMemoById(type, examNum, username, id).then((res) => {
      // console.log(exam);
      console.log(res);
